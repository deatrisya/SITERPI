...
<div style="overflow: border: 1px solid #000; margin: auto; padding: 30px; width: 90%; background-color: none;">
    ...
    <h4 align="center">LAPORAN DATA JENIS OBAT</h4>
    ...
    <table style="border-collapse:collapse;" align="center">
        <thead>
            <tr>
                ...
                <th style="border:1px solid #000; text-align: center;padding: 4px; width: 100px;background-color: rgb(197, 197, 197);">Satuan</th>
                <th style="border:1px solid #000; text-align: center;padding: 4px; width: 100px;background-color: rgb(197, 197, 197);">Harga (Rp)</th>
            </tr>
        </thead>
        <tbody>
            @foreach($jenisObat as $data)
            <tr>
                <td style="border:1px solid #000; text-align: center;padding: 4px; width: 40px;">{{$loop->iteration}}</td>
                <td style="border:1px solid #000; text-align: center;padding: 4px; width: 250px">{{$data->nama_obat}}</td>
                <td style="border:1px solid #000; text-align: center;padding: 4px; width: 120px">{{$data->satuan}}</td>
                <td style="border:1px solid #000; text-align: right;padding: 4px; width: 200px">{{number_format($data->harga),2}},00</td>
            </tr>
            @endforeach
        </tbody>
    </table>
