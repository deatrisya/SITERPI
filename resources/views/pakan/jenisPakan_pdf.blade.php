...
<head>
<meta charset="UTF-8">
    <title>Laporan Jenis Pakan</title>
</head>
...
<div style="overflow: border: 1px solid #000; margin: auto; padding: 30px; width: 90%; background-color: none;">
    ...
    <h4 align="center">LAPORAN DATA JENIS PAKAN</h4>
    ...
    <table style="border-collapse:collapse;" align="center">
        <thead>
            <tr>
                ...
                <th style="border:1px solid #000; text-align: center;padding: 4px; width: 475px;background-color: rgb(197, 197, 197);">Jenis Pakan</th>
                <th style="border:1px solid #000; text-align: center;padding: 4px; width: 100px;background-color: rgb(197, 197, 197);">Harga (Rp)</th>
            </tr>
        </thead>
        <tbody>
            @foreach($jenisPakan as $j)
            <tr>
                <td style="border:1px solid #000; text-align: center;padding: 4px; width: 40px;">{{$loop->iteration}}</td>
                <td style="border:1px solid #000; text-align: center;padding: 4px; width: 475px">{{$j->jenis_pakan}}</td>
                <td style="border:1px solid #000; text-align: right;padding: 4px; width: 100px">{{number_format($j->harga),2}},00</td>
            </tr>
            @endforeach
        </tbody>
    </table>
